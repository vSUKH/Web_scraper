...
#     body_contect = soup.body
#     if body_contect:
#         return str(body_contect)
#     return ""

# def clean_body_content(body_contect):
#     soup = BeautifulSoup(body_contect,"html.parser")
...
# def split_dom_comtect (dom_content,max_length=6000):
#     return[
